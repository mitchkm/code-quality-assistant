...
exports.exampleData = {
    ...
    files: {
        ...
        "1": {
            filename: "/mnt/g/Projects/apple-surp-2019/code-analysis/examples-to-analyze/analyze-you.swift",
            functions: {
                "0": {
                    name: "viewDidLoad",
                    nloc: 10,
        ...
        "2": {
            filename: "/mnt/g/Projects/apple-surp-2019/code-analysis/examples-to-analyze/analyze-them.swift",
            functions: {
                "0": {
                    name: "viewDidLoad",
                    nloc: 22,
        ...
        "3": {
            filename: "/mnt/g/Projects/apple-surp-2019/code-analysis/examples-to-analyze/analyze-us.swift",
            functions: {
                "0": {
                    name: "viewDidLoad",
                    nloc: 26,
...
exports.exampleProcessedData = {
    name: "nlocxccn",
    value: 54,
    value2: 13,
    children: [
        {
            name: "/mnt/g/Projects/apple-surp-2019/code-analysis/examples-to-analyze/analyze-me.swift",
            value: 54,
            value2: 13,
            children: [
        ...
        {
            name: "/mnt/g/Projects/apple-surp-2019/code-analysis/examples-to-analyze/analyze-you.swift",
            value: 54,
            value2: 13,
            children: [
...
const treemapData_1 = require("./treemapData");
const treemapOptions_1 = require("./treemapOptions");
const width = 100;
const height = 100;
const gamma = 1.0;
...
const treemapData = new treemapData_1.default();
const processedData = treemapData.processData();
const treemap = new treemap_1.default(processedData, width, height, color);
const treemapOptions = new treemapOptions_1.default(processedData);
treemapOptions.setUpTreemapOptions(treemap);
console.log(treemap);
treemap.drawTreemap();

},{"./treemap":40,"./treemapData":41,"./treemapOptions":42,"d3":32}],37:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class MetricData {
    constructor(rawData) {
    ...
    toTreemapData(metricA, metricB, aggregateA = this.sumArray, aggregateB = this.sumArray) {
        const data = {
            name: "",
            value: 0,
            value2: 0,
...
class SelectorFactory {
    ...
    getSelector(selectorType) {
        ...
        if (selectorType.toLowerCase() === "file") {
            const fileSelector = new fileSelector_1.default(this.processedData);
            return fileSelector;
        }
        if (selectorType.toLowerCase() === "color") {
            const colorSelector = new colorSelector_1.default();
            return colorSelector;
        }
        if (selectorType.toLowerCase() === "size") {
            const sizeSelector = new sizeSelector_1.default();
            return sizeSelector;
        }
    }
}
...
},{"./colorSelector":33,"./fileSelector":35,"./sizeSelector":39}],39:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const d3 = require("d3");
class SizeSelector {
...
const treemapData_1 = require("./treemapData");
class Treemap {
    constructor(proceesedData, width, height, color) {
    ...
    createTreemap(paddingTop, paddingBottom, paddingLeft, paddingRight) {
    ...
    zoomTreemap(d, chart, upButton, nodes) {
    ...
    updateTreemap() {
        ...
        const treemapData = new treemapData_1.default(selectedSize, selectedColor, selectedFile);
        const processedData = treemapData.processData();
...
},{"./treemapData":41,"d3":32}],41:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class TreemapData {
    ...
    processData() {
        ...
        try {
            ...
            data = example_1.exampleData;
        }
        const mD = new metricData_1.MetricData(data);
        if (this.fileOption !== "none") {
            mD.ignore(this.fileOption);
        }
        const processedData = mD.toTreemapData(this.sizeOption, this.colorOption);
        return processedData;
    }
}
exports.default = TreemapData;

},{"./example":34,"./metricData":37}],42:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const selectorFactory_1 = require("./selectorFactory");
const d3 = require("d3");
class TreemapOptions {
    constructor(processedData) {
        this.processedData = processedData;
    }
    setUpTreemapOptions(treemap) {
        const selectors = new selectorFactory_1.default(this.processedData);
    ...
    changeSizeOption(treemap) {
        d3.select("#sizeSelector")
            .on("change", (d) => {
            treemap.updateTreemap();
        });
    }
    changeColorOption(treemap) {
        d3.select("#colorSelector")
            .on("change", (d) => {
            treemap.updateTreemap();
        });
    }
    changeFileOption(treemap) {
...
exports.default = TreemapOptions;

},{"./selectorFactory":38,"d3":32}]},{},[36]);
